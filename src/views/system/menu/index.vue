<template>
  <div class="app-container">
    <el-tabs v-model="query.en" style="padding-left: 5px;" @tab-click="crud.toQuery">
      <el-tab-pane label="后台管理" name="0" />
      <el-tab-pane label="用户系统" name="1" />
    </el-tabs>
    <!--工具栏-->
...
// crud交由presenter持有
const defaultForm = { id: null, title: null, menuSort: 999, path: null, component: null, componentName: null, iframe: false, roles: [], pid: 0, icon: null, cache: false, hidden: false, type: 0, permission: null, en: 0 }
export default {
  name: 'Menu',
  ...
  methods: {
    ...
    [CRUD.HOOK.afterToCU](crud, form) {
      // console.log(this.query.en)
      form.en = this.query.en
      this.menus = []
      if (form.id != null) {
        if (form.pid === null) {
          form.pid = 0
    ...
    loadMenus({ action, parentNode, callback }) {
      if (action === LOAD_CHILDREN_OPTIONS) {
        crudMenu.getMenusTree(parentNode.id, this.query.en).then(res => {
